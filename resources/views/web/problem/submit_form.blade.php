<form class="form-horizontal submit" role="form" method="post" action="{{ isset($contest) ? route('contest.solution.store', ['contest' => $contest->id]) : route('solution.store') }}">
    <div class="form-group submit-meta">
        ...
        <div class="col-sm-4">
            ...
            @isset($contest)
                <input name="order" id="order" value="{{ $problem->order() }}" type="hidden"/>
            @endisset
